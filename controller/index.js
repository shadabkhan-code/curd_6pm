...
async function storeRecord(req, res) {
    try {
        ...
        let errorMessage = {}
        error.errors?.name ? errorMessage['name'
        ] = error.errors?.name?.message : null
        error.errors?.email ? errorMessage['email'
        ] = error.errors?.email?.message : null
        error.errors?.phone ? errorMessage['phone'
        ] = error.errors?.phone?.message : null
        error.errors?.designation ? errorMessage['designation'
        ] = error.errors?.designation?.message : null
        error.errors?.salary ? errorMessage['salary'
        ] = error.errors?.salary?.message : null
        res.render("add",
        {
            data: data,
...
async function deteteRecord(req,res){
    try{
